...
define("ghost-admin/tests/acceptance/settings/labs-test", ["ember-simple-auth/test-support", "mocha", "@ember/test-helpers", "chai", "ghost-admin/tests/helpers/file-upload", "ember-mocha", "ember-cli-mirage/test-support", "ghost-admin/tests/helpers/visit"], function (_testSupport, _mocha, _testHelpers, _chai, _fileUpload, _emberMocha, _testSupport2, _visit) {
  ...
  (0, _mocha.describe)('Acceptance: Settings - Labs', function () {
    ...
    (0, _mocha.describe)('When logged in as Owner', function () {
      ...
      (0, _mocha.it)('sets the mailgunBaseUrl to the default', async function () {
        await (0, _visit.visit)('/settings/labs');
        await (0, _testHelpers.click)('[data-test-toggle="enable-members"]');
...
define("ghost-admin/tests/integration/components/gh-members-import-table-test", ["@ember/test-helpers", "mocha", "chai", "ember-mocha"], function (_testHelpers, _mocha, _chai, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration: Component: gh-members-import-table', function () {
    ...
    (0, _mocha.it)('renders empty without data', async function () {
      await (0, _testHelpers.render)(Ember.HTMLBars.template(
      /*
      ...
      */
      {"id":"SAhZOBFV","block":"{\"symbols\":[],\"statements\":[[2,\"\\n            \"],[8,\"gh-members-import-table\",[],[[],[]],null],[2,\"\\n        \"]],\"hasEval\":false,\"upvars\":[]}","meta":{}}));
      (0, _chai.expect)((0, _testHelpers.find)('table')).to.exist;
      (0, _chai.expect)((0, _testHelpers.findAll)('table thead th').length).to.equal(3);
      (0, _chai.expect)((0, _testHelpers.findAll)('table tbody tr').length).to.equal(1);
      (0, _chai.expect)((0, _testHelpers.find)('table tbody').textContent).to.match(/No data/);
    });
    (0, _mocha.it)('renders members data with all the properties', async function () {
      ...
      */
      {"id":"nXMzboiL","block":"{\"symbols\":[],\"statements\":[[2,\"\\n            \"],[8,\"gh-members-import-table\",[],[[\"@importData\",\"@mapping\"],[[32,0,[\"importData\"]],[32,0,[\"mapping\"]]]],null],[2,\"\\n        \"]],\"hasEval\":false,\"upvars\":[]}","meta":{}}));
...
define("ghost-admin/tests/integration/components/gh-timezone-select-test", ["sinon", "@ember/test-helpers", "mocha", "chai", "ember-mocha"], function (_sinon, _testHelpers, _mocha, _chai, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration: Component: gh-timezone-select', function () {
    ...
    (0, _mocha.it)('renders', async function () {
      ...
      /*
        {{gh-timezone-select
                  ...
                  timezone=timezone}}
      */
      {"id":"vOyMaAPw","block":"{\"symbols\":[],\"statements\":[[1,[30,[36,2],null,[[\"availableTimezones\",\"timezone\"],[[35,1],[35,0]]]]]],\"hasEval\":false,\"upvars\":[\"timezone\",\"availableTimezones\",\"gh-timezone-select\"]}","meta":{}}));
      (0, _chai.expect)(this.element, 'top-level elements').to.exist;
      (0, _chai.expect)((0, _testHelpers.findAll)('option'), 'number of options').to.have.length(3);
    ...
    (0, _mocha.it)('handles an unknown timezone', async function () {
      ...
      /*
        {{gh-timezone-select
                  ...
                  timezone=timezone}}
      */
      {"id":"vOyMaAPw","block":"{\"symbols\":[],\"statements\":[[1,[30,[36,2],null,[[\"availableTimezones\",\"timezone\"],[[35,1],[35,0]]]]]],\"hasEval\":false,\"upvars\":[\"timezone\",\"availableTimezones\",\"gh-timezone-select\"]}","meta":{}})); // we have an additional blank option at the top
    ...
    (0, _mocha.it)('triggers update action on change', async function () {
      ...
      */
      {"id":"UapNiNYW","block":"{\"symbols\":[],\"statements\":[[1,[30,[36,4],null,[[\"availableTimezones\",\"timezone\",\"update\"],[[35,3],[35,2],[30,[36,1],[[32,0],[35,0]],null]]]]]],\"hasEval\":false,\"upvars\":[\"update\",\"action\",\"timezone\",\"availableTimezones\",\"gh-timezone-select\"]}","meta":{}}));
...
define("ghost-admin/tests/integration/components/modal-import-members-test", ["jquery", "pretender", "sinon", "@ember/test-helpers", "mocha", "chai", "ghost-admin/tests/helpers/file-upload", "ember-mocha"], function (_jquery, _pretender, _sinon, _testHelpers, _mocha, _chai, _fileUpload, _emberMocha) {
  "use strict";
  ...
  (0, _mocha.describe)('Integration: Component: modal-import-members-test', function () {
    ...
    (0, _mocha.it)('renders', async function () {
      ...
      */
      {"id":"Uh0BBgoi","block":"{\"symbols\":[],\"statements\":[[1,[34,0]]],\"hasEval\":false,\"upvars\":[\"modal-import-members\"]}","meta":{}}));
    ...
    (0, _mocha.it)('generates request to supplied endpoint', async function () {
      ...
      */
      ...
      await (0, _testHelpers.click)('.gh-btn-green');
      (0, _chai.expect)(server.handledRequests.length).to.equal(1);
      (0, _chai.expect)(server.handledRequests[0].url).to.equal('/ghost/api/v3/admin/members/upload/');
    });
    ...
    (0, _mocha.it)('validates extension by default', async function () {
      ...
      */
      {"id":"Uh0BBgoi","block":"{\"symbols\":[],\"statements\":[[1,[34,0]]],\"hasEval\":false,\"upvars\":[\"modal-import-members\"]}","meta":{}}));
      await (0, _fileUpload.fileUpload)('input[type="file"]', ['membersfile'], {
        name: 'test.txt'
      });
      (0, _chai.expect)((0, _testHelpers.findAll)('.failed').length, 'error message is displayed').to.equal(1);
      (0, _chai.expect)((0, _testHelpers.find)('.failed').textContent).to.match(/The file type you uploaded is not supported/);
...
define("ghost-admin/tests/integration/services/member-import-validator-test", ["pretender", "mocha", "chai", "ember-mocha"], function (_pretender, _mocha, _chai, _emberMocha) {
  ...
  (0, _mocha.describe)('Integration: Service: member-import-validator', function () {
    ...
    (0, _mocha.it)('checks correct data without Stripe customer', async function () {
      ...
      (0, _chai.expect)(validationErrors.length).to.equal(0);
      (0, _chai.expect)(mapping.email).to.equal('email');
    });
    (0, _mocha.it)('returns validation error when no data is provided', async function () {
      let service = this.owner.lookup('service:member-import-validator');
      const {
        validationErrors
      } = await service.check([]);
      (0, _chai.expect)(validationErrors.length).to.equal(1);
      (0, _chai.expect)(validationErrors[0].message).to.equal('File is empty, nothing to import. Please select a different file.');
    });
    (0, _mocha.it)('returns validation error for data with stripe_customer_id but no connected Stripe', async function () {
      ...
      (0, _chai.expect)(validationErrors.length).to.equal(1);
      (0, _chai.expect)(validationErrors[0].message).to.equal('Missing Stripe connection');
      (0, _chai.expect)(mapping.name).to.equal('name');
      (0, _chai.expect)(mapping.email).to.equal('email');
      (0, _chai.expect)(mapping.stripe_customer_id).to.equal('stripe_customer_id');
    });
    (0, _mocha.it)('returns validation error for no valid emails', async function () {
      this.owner.register('service:membersUtils', Ember.Service.extend({
        isStripeEnabled: false
      }));
      let service = this.owner.lookup('service:member-import-validator');
      ...
      (0, _chai.expect)(validationErrors.length).to.equal(1);
      (0, _chai.expect)(validationErrors[0].message).to.equal('No email addresses found in the uploaded CSV.');
    });
    (0, _mocha.it)('ignores validation for invalid email', async function () {
      this.owner.register('service:membersUtils', Ember.Service.extend({
        isStripeEnabled: false
      }));
      let service = this.owner.lookup('service:member-import-validator');
    ...
    (0, _mocha.describe)('data detection method', function () {
      ...
      (0, _mocha.it)('correctly detects only email mapping', async function () {
        ...
        (0, _chai.expect)(result.email).to.equal('correo_electronico');
        (0, _chai.expect)(result.stripe_customer_id).to.equal('stripe_id');
      });
...
define("ghost-admin/tests/lint/app.lint-test", [], function () {
  ...
  describe('ESLint | app', function () {
    ...
    it('components/modal-members-modal-settings.js', function () {// test passed
    });
